...
[TestFixture]
public class DipteshAssignment4Test
{
    ...
    public void insuranceQuote01()
    {
        ...
        driver.FindElement(By.Id("address")).SendKeys("38 Rauch Court");
        driver.FindElement(By.Id("city")).SendKeys("Kitchener");
        driver.FindElement(By.Id("postalCode")).SendKeys("N2N 3C7");
        driver.FindElement(By.Id("phone")).SendKeys("234-765-8765");
        driver.FindElement(By.Id("email")).SendKeys("dipteshpatel2456@gmail.com");
    ...
    public void insuranceQuote04()
    {
        ...
        driver.FindElement(By.Id("phone")).SendKeys("234-7658765");
        driver.FindElement(By.Id("age")).Click();
    ...
    public void insuranceQuote05()
    {
        ...
        driver.FindElement(By.Id("postalCode")).SendKeys("N2N 3C7");
        driver.FindElement(By.Id("phone")).SendKeys("234-7658765");
        driver.FindElement(By.Id("email")).SendKeys("dipteshpatel2456gmail.com");
    ...
    public void insuranceQuote06()
    {
        ...
        driver.FindElement(By.Id("postalCode")).SendKeys("N2 3C7");
        driver.FindElement(By.Id("btnSubmit")).Click();
